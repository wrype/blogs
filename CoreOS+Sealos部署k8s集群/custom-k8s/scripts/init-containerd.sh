...
tar -zxf ../cri/cri-containerd.tar.gz --strip-components 2 -C ${binPath}
# shellcheck disable=SC2046
chmod a+x $(tar -tf ../cri/cri-containerd.tar.gz | while read -r binary; do echo "${binPath}/${binary##*/}"; done | xargs)
